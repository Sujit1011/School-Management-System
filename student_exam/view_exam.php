                    ...
                    <div class="container">
                        <div class="col-xl-12 col-sm-12">
                                ...
                                while($row = mysqli_fetch_assoc($result))
                                {
                                    ...
                                    $exp_time=$row['Start Time'] ;
                                    $exp_date=$row['Start Date'] ;
                                    ...
                                    if($td>$exp || $td<$exp){                                 
                                    echo'                                                                            
                                       <div class="d-flex justify-content-center mt-4 disabled">
                                        <a href="take_exam.php?id='.$row['id'].'" class="btn btn-primary mb-2 disabled">Take Exam</a>
                                          </div>
                                        </div>
                                    </div>'; 
                                }                                                                   
                                         ...
                                         echo'<div class="d-flex justify-content-center mt-4">
                                                <a href="take_exam.php?id='.$row['id'].'" class="btn btn-primary mb-2">Take Exam</a>
                                            </div>
                                        </div>
                                    </div>';
                                }                                   
