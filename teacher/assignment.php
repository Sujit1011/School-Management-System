            ...
            <div id="content">
                ...
                <div class="container-fluid" style="height: 100%;">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Schedule Assignment</h1>
                    </div>
                    <?php
                    if ($_SERVER['REQUEST_METHOD'] == 'POST') {
                        if (isset($_POST['submit1'])) {
                            ...
                            $assignment_class = implode(',', $_POST['class']);
                            $assignment_info = $_POST['assignment_info'];
                            $before_time = $_POST['before_time'];
                            $due_date = $_POST['due_date']; 

                            $filename = $_FILES["uploadfile"]["name"];
                            $tempname = $_FILES["uploadfile"]["tmp_name"];
                            $folder ="../uploads/upload_assignment/".$filename;
                            move_uploaded_file($tempname,$folder);


                            $id=$_SESSION['id'];
                            $sql1="INSERT INTO `schedule_assignment`(`assignment_name`,`assignment_class`,`assignment_info`,`before_time`,`due_date`, `tid`, `assignment_file`) VALUES ('$assignment_name','$assignment_class','$assignment_info','$before_time','$due_date', $id, '$folder');";
                            ...
                            <form action="assignment.php" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="form-row">
                                  <div class="form-group col-md-12">
                                    ...
                                    <textarea class="form-control" id="exampleFormControlTextarea1" name="assignment_info" rows="3"></textarea>
                                  </div>
                                </div>
                                ...
                                <div class="form-row">
                                  ...
                                  <div class="form-group col-md-4">
                                    <label for="beforetime">Before Time</label>
                                    <input type="time" class="form-control" name="before_time" required>
                                  </div>
                                  <div class="form-group col-md-4">
                                  ...
                                  <div class="form-group col-md-4">
                                    <label for="assignmentinfo">Assignment related pdf file</label>
                                    <!--<textarea class="form-control" id="exampleFormControlTextarea1" name="assignment_info" rows="3"></textarea>-->
                                    <input type="file" name="uploadfile" value="image" class="form-control" accept="application/pdf" style="padding-top: 3px;">
                                  </div>
                                  <!-- <div class="form-group col-md-4">
                                    <label for="upload">Uplooad</label>
                                    <input type="file" class="form-control" name="uploadfile" value="image" accept="application/pdf" required>
                                  </div> -->
