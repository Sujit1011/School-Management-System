...
$sql1="select count(*) as total from student where status='Verified' ";
                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">
                                                Total Classes</div>
                                             <?php
                                                echo '<div class="h5 mb-0 font-weight-bold text-gray-800">'.$data3['total'].'</div>';
                                            ?> 
                                        </div>
                                        <div class="col-auto">
                                            <i class="fas fa-user fa-2x text-gray-300"></i>
                    ...
                    <div class="container px-5">
                        <div class="row">
                            <div class="col-xl-7">
                                ...
                                <?php
                                    $sql="select * from schedule_meeting ORDER BY meeting_id DESC";
                                    ...
                                    while($row = mysqli_fetch_assoc($result))
                                    {
                                        ...
                                        '<div class="card shadow mb-4">
                                            <div class="card-body">
                                                <h3 class="card-title mb-4">'. $row['meeting_name'] .'</h3>
                                                <div class="d-flex">
                                                    <h6 class="card-subtitle mb-2 text-muted">Start Date: '. $row['start_date'] .'</h6>
                                                    <h6 class="card-subtitle mb-2 ml-3 text-muted">Start Time: '. $row['start_time'] .'</h6>
                                                    <h6 class="card-subtitle mb-2 ml-3 text-muted">Class: '. $row['meeting_class'] .'</h6>
                                                </div>
                                                <p class="card-text">'. $row['meeting_info'] .'</p>
                                                <a target="_blank" href="'. $row['meeting_link'] .'">Meeting Link</a>
                                            </div>
                                        </div>';
                                    }
                                    ?>
                            ...
                            <div class="col-xl-5">
                                ...
                                <?php
                                    $sql="select * from schedule_assignment ORDER BY assignment_id DESC";
                                    $result=mysqli_query($conn,$sql);
                                    while($row = mysqli_fetch_assoc($result))
                                    {
                                        echo 
                                        '<div class="card shadow mb-4">
                                            <div class="card-body">
                                                <h3 class="card-title mb-4">'. $row['assignment_name'] .'</h3>
                                                <div class="d-flex">
                                                    <h6 class="card-subtitle mb-2 text-muted">Start Date: '. $row['due_date'] .'</h6>
                                                    <h6 class="card-subtitle mb-2 ml-4 text-muted">Start Time: '. $row['before_time'] .'</h6>
                                                </div>
                                                <p class="card-text">'. $row['assignment_info'] .'</p>
                                                <a target="_blank" href="#">File Link</a>
                                            </div>
                                        </div>';
                                    }
                                    ?>
