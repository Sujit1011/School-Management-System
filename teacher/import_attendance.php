...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    if (isset($_POST['submit'])) {
        ...
        $folder ="../uploads/upload_attendance/".$filename;
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Import Attendance</h1>
                    </div>
                        ...
                        <div class="container py-4">
                            ...
                            <div class="row">
                                <div class="form-group col-md-4">
                                    <label for="assignmentinfo">File</label>
                                    <input type="file" name="uploadfile" class="form-control" accept="application/txt" style="padding-top: 3px;">
                                </div>
                                <div class="col-md-4 col-sm-6">
                                    <label for="filtermonth">Date</label>
                                    <input type="date" class="form-control" name="date" required>
                                </div>
                                <div class="col-md-4 col-sm-4 pt-6">
