...
if ($_SERVER['REQUEST_METHOD'] == 'POST') 
{
    if (isset($_POST['submit'])) 
    {
        ...
        $sql = "INSERT INTO `exams`(`class`, `title`, `total question`, `durations`, `total marks`, `start date`, `start time`) VALUES ('$class','$examname',$question,$duration,$totalmarks,'$startdate','$starttime')";
        $run = mysqli_query($conn,$sql);
        if ($run) {
            echo "Exam Posted Successfully";
        } else {
            echo "Exam Posted Unsuccessfully";
        }
    }
}
                        ...
                        <form action="create_exam.php" method="post">
                            <div class="row">
                                ...
                                <div class="col-md-6 col-sm-4">
                                    ...
                                    <input type="text" class="form-control" id="examname" name="examname" placeholder="Enter Title">
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-4 col-sm-4">
                                    <label for="question">Question</label>
                                    <input type="text" class="form-control" id="question" name="question" placeholder="Enter Total Question">
                                </div>
                                <div class="col-md-4 col-sm-4">
                                    <label for="duration">Durations</label>
                                    <input type="text" class="form-control" id="duration" name="duration" placeholder="Enter in Munutes">
                                </div>
                                <div class="col-md-4 col-sm-4">
                                    <label for="totalmarks">Total Marks</label>
                                    <input type="text" class="form-control" id="totalmarks" name="totalmarks" placeholder="Enter Total Marks">
                                </div>
                            </div>
                            <div class="row pt-2">
                                <div class="col-md-6 col-sm-6">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4 col-sm-4 pt-4">
                                    <input type="submit" class="btn btn-primary btn-block" value="Create" name="submit">
                                </div>
                            </div>
                        </form>
                        </div>
