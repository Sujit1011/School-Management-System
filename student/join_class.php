        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="d-sm-flex align-items-center justify-content-between mb-4">
                    <h1 class="h3 mb-0 text-gray-800" style="padding-left: 10px;">Join Class</h1>
                </div>
                ...
                <form action="join_class.php" method="POST">
                             ...
                             <select id="inputState" name="class[]" class="form-control" required>
                                 ...
                                 <?php $sql = "SELECT class_id,Class FROM `class`";
                                    ...
                                    while ($row = mysqli_fetch_assoc($result)) {
                                        echo '  <option>  <li><a class="dropdown-item"' . $row['class_id'] . '">' . $row['Class'] . '</a></li></option>';
                                    } ?>
                             </select>
                         </div>
                    ...
                    <div class="div" style="padding-left:10px">
                        ...
                        <button type="submit" name="submit1" class="btn" style="background-color:#FF4584;color:white;">Join</button>
                    </div>
                </form>
                ...
                if ($_SERVER['REQUEST_METHOD'] == 'POST') {                  
                        if (isset($_POST['submit1'])) {                                               
                            ...
                            $s_id=$_SESSION['sid'];
                            $sql1="update student set class_joined = '$class' where sid = '$s_id'";
                            // $sql = "INSERT INTO student (subject_joined) VALUES ('" . $checkBox . "')";
                            $run=mysqli_query($conn, $sql1);
                            if ($run) {
                                echo '<div class="form-group col-md-6 py-3">
                                <p> Class Joined Successfully , Please Logout and then Login again<p>
                                </div>';
                            } 
                            else {
                                echo 'Class Joined UnSuccessful';
                            }
                        }                                
                }
                ?>
