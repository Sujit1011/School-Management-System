...
// $sql2="select count(*) as total from student where status='Applied' ";
            ...
            <div id="content">
                ...
                <div class="container-fluid" style="height: 100%;">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between my-4">
                        <h1 class="h3 mb-0 text-gray-800">All Meetings</h1>
                    </div>
                    ...
                    <div class="container px-5">
                        ...
                        $sql = "SELECT * FROM `schedule_meeting` WHERE meeting_class='$class_joined'";
                        ...
                        while ($row = mysqli_fetch_assoc($result)) {
                            ...
                            echo '  <div class="card shadow mb-4">
                                <div class="card-body">
                                    <h3 class="card-title mb-4">' . $meeting_name . '</h3>
                                    <div class="d-flex">
                                        <h6 class="card-subtitle mb-2 text-muted">Start Date: ' . $start_date . '</h6>
                                        <h6 class="card-subtitle mb-2 ml-4 text-muted">Start Time: ' . $start_time . '</h6>
                                    </div>
                                    <p class="card-text">' . $meeting_info . '</p>
                                    <a href="' . $meeting_link . '" target="_blank">Meeting Link</a>
                                </div>
                            </div>';
                        }
                        if ($noResult){
                            echo'<div class="card shadow mb-4">
                            <div class="card-body">
                                <h3 class="card-title mb-4">No Lectures Found</h3>                               
                            </div>
                        </div>';
                         }
                        ?>
